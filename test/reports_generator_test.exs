defmodule ReportsGeneratorTest do
  ...
  describe "fetch_highest_value/2" do
    test "when the option is 'users', returns the user who spent the most" do
      ...
      response =
        file_name
        |> ReportsGenerator.build()
        |> ReportsGenerator.fetch_highest_value("users")
    ...
    test "when the option is 'foods', returns the most consumed food" do
      ...
      response =
        file_name
        |> ReportsGenerator.build()
        |> ReportsGenerator.fetch_highest_value("foods")
    ...
    test "when the option is invalid, returns an error" do
      ...
      response =
        file_name
        |> ReportsGenerator.build()
        |> ReportsGenerator.fetch_highest_value("invalid")
